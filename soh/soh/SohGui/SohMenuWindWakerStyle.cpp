    ...
    AddWidget(path, "Visão de Diagnóstico: %d", WIDGET_CVAR_SLIDER_INT)
        ...
        .Options(IntSliderOptions()
                     .Tooltip("0 = desligado.\n\n"
                              ...
                              "5 = o que a comparação de profundidade devolveu, cru. Se o contorno já sai "
                              "facetado AQUI, quem desenhou o defeito foi a comparação ou o próprio mapa — a "
                              "resolução dele, a matriz com que foi desenhado, ou o ajuste do depth pass — e "
                              "nada do lado do sombreamento alcança isso.\n\n"
                              "DUAS coisas ficam entre esta visão e a imagem sombreada, e nenhuma tem visão "
                              "própria: o limiar cel, que remapeia a cobertura por uma rampa estreita "
                              "centrada na metade, e o peso de incidência, que reduz a força da sombra "
                              "conforme a superfície fica de lado para a luz.\n\n"
                              "Onde a imagem sombreada tiver MENOS sombra que esta visão, suspeite do peso "
                              "e de uma superfície quase tangente à luz. Onde o contorno estiver mais duro "
                              "ou mais torto, suspeite do limiar.\n\n"

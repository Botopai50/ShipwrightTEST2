    ...
    AddWidget(path, "Visão de Diagnóstico: %d", WIDGET_CVAR_SLIDER_INT)
        ...
        .Options(IntSliderOptions()
                     .Tooltip("0 = desligado.\n\n"
                              ...
                              "UMA coisa fica entre esta visão e a imagem sombreada: o limiar cel, que "
                              "remapeia a cobertura por uma rampa estreita centrada na metade. Nada mais "
                              "escala a força da sombra por pixel — um peso que fazia isso estava pintando "
                              "os próprios triângulos da malha nas paredes.\n\n"

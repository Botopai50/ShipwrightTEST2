    ...
    AddWidget(path, "Visão de Diagnóstico: %d", WIDGET_CVAR_SLIDER_INT)
        ...
        .Options(IntSliderOptions()
                     .Tooltip("0 = desligado.\n\n"
                              ...
                              "Uma coisa fica entre esta visão e a imagem sombreada: o peso de incidência, "
                              "que reduz a força da sombra conforme a superfície fica de lado para a luz. "
                              "Onde a imagem sombreada tiver MENOS sombra que esta visão, é esse peso, e a "
                              "superfície está quase tangente à luz.\n\n"
